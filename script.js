...
document.getElementById("sliderValue2").innerHTML = "Straight";
...
function stopMotors(sliderNumber){
    ...
    if(sliderNumber == 2){
        document.getElementById("r_btn").className = "right_btn"
        document.getElementById("l_btn").className = "left_btn" 
    }
...
function run(){
    ...
    if(speed == 0){
        ...
        if(direction < 0){
            ...
            // roda2 = speed
            document.getElementById("l_btn").className = "left_btn_active"
            document.getElementById("r_btn").className = "right_btn"
            ...
            // roda1 = speed
            document.getElementById("l_btn").className = "left_btn"
            document.getElementById("r_btn").className = "right_btn_active"
...
function turn(direction){
    if(direction == 1){
        if(document.getElementById("slider2").value == -100){
            document.getElementById("slider2").value = parseInt(0)
            document.getElementById("r_btn").className = "right_btn"
            document.getElementById("l_btn").className = "left_btn"
            document.getElementById("sliderValue2").innerHTML = "Straight"
        } else{
            document.getElementById("slider2").value = parseInt(-100)
            document.getElementById("l_btn").className = "left_btn_active"
            document.getElementById("r_btn").className = "right_btn"
            document.getElementById("sliderValue2").innerHTML = "Left"
        }
    } else{
        if(document.getElementById("slider2").value == 100){
            document.getElementById("slider2").value = parseInt(0)
            ...
            document.getElementById("l_btn").className = "left_btn"
            document.getElementById("r_btn").className = "right_btn_active"
            document.getElementById("sliderValue2").innerHTML = "Right"
        }
    }
    run()
}